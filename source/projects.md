...
4. [AprilTags localization video](https://www.youtube.com/watch?v=Y8WEGGbLWlA)
5. [AprilTags ROS package](http://wiki.ros.org/apriltags_ros)
...
### **State-space controller design and state estimation using Kalman Filter**
...
1. [Video of corner drifting](https://www.youtube.com/watch?time_continue=11&v=hnvj4rgrAy0&feature=emb_logo)
2. [Paper on LQR controller design for drifting an 1/10 RC car](https://borrelli.me.berkeley.edu/pdfpub/auto_drift.pdf)
3. [Thesis on LQR controller design for RC car](https://www.diva-portal.org/smash/get/diva2:1149520/FULLTEXT01.pdf)
4. [MPC controller paper](https://arxiv.org/pdf/1610.06534.pdf)
5. [MPC controller website](https://automatedcars.space/home/2017/4/18/firkxklwjl37emejf1eeevw7a6ulvh)
6. [Kalman filter python library](https://github.com/rlabbe/filterpy) + [book explaining the library](https://github.com/rlabbe/Kalman-and-Bayesian-Filters-in-Python/)
7. [Reference controller implementation on a 1/10 car (BARC source code)](https://github.com/MPC-Berkeley/barc/tree/master/workspace/src/barc/src)

### **Localization using AprilTags as landmarks**

**Topic**: *Perception* **Priority**: *High* **Difficulty**: *Medium*

Real cars have the advantage of using GPS for localization, but this is not the case for Race On cars. Knowing the exact position of the car on the track offers a big advantage as it allows a more precise path planning which heavily outperforms the stay-in-the-middle strategy. By placing two or three AprilTags on each segment, an accurate track map can be constructed and used for precise localization of the car on the track. Moreover, this localization can be also used in estimating the car model parameters of the state-space controller.

References:

1. [Demo video](https://www.youtube.com/watch?v=Y8WEGGbLWlA)
2. [Mobile Robot Localization, Chapter 7](https://raw.githubusercontent.com/yvonshong/Probabilistic-Robotics/master/Probabilistic-Robotics-en.pdf)
3. [Different localization algorithms](https://pythonrobotics.readthedocs.io/en/latest/modules/localization.html)
4. [Some insight on choosing AprilTags for localization](http://wiki.lofarolabs.com/index.php/Localizing_with_AprilTags)
5. [Similar project source code (in chinese)](https://github.com/lifuguan/AprilTag_Localization)
...
1. [Calibrate camera with ROS demo video](https://www.youtube.com/watch?v=yAYqt3RpT6c)
2. [Camera calibration explanation + code](https://nikolasent.github.io/opencv/2017/05/05/Camera-calibration-with-OpenCV.html)
3. [Bird’s eye view explanation + code](https://nikolasent.github.io/opencv/2017/05/07/Bird's-Eye-View-Transformation.html)
4. [Rolling Shutter Calibration + IMU based on camera + papers](https://github.com/ethz-asl/kalibr)
...
1. [Demo Video](https://www.youtube.com/watch?v=homos4vd_Zs)
2. [Tutorial](http://avisingh599.github.io/vision/monocular-vo/)
3. [An overview of image based localization](https://arxiv.org/pdf/1610.03660)
4. [Similar project](https://github.com/SonamYeshe/ENPM673-Perception-for-Autonomous-Robots/tree/master/2.0_VisualOdometry)
...
1. [Demo Video](https://www.youtube.com/watch?v=SZ9c_3HUVUE)
2. [Explanation](https://medium.com/@theclassytim/robotic-path-planning-rrt-and-rrt-212319121378)
3. [Source code + other similar algorithms](https://pythonrobotics.readthedocs.io/en/latest/modules/path_planning.html)
4. [Vehicle Path Planning paper](https://www.cs.cmu.edu/~motionplanning/reading/PlanningforDynamicVeh-1.pdf)
